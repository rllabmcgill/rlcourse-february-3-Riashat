# compuate update of Advantage Function based on Importance Samplinh

# A(s,a) should have lower variance than Q(s,a) since a baseline of V(s) is considered here.
...
def create_greedy_policy(Advantage_Function):
    """
...
def mc_control_importance_sampling(env, num_episodes, behavior_policy, discount_factor=1.0):
    ...
    for i_episode in range(1, num_episodes + 1):
        ...
        for t in range(len(episode))[::-1]:
            ...
            Advantage_Function[state][action] += (W / C[state][action]) * (G - Advantage_Function[state][action])
...
def main():
    ...
    Q, policy, Advantage_Function = mc_control_importance_sampling(env, num_episodes=5000, behavior_policy=random_policy)
